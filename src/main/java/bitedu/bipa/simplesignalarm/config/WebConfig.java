...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**") // 모든 엔드포인트에 대한 CORS 설정을 적용
                .allowedOrigins("http://localhost:3000","http://localhost:8080", "https://ec2-43-202-224-51.ap-northeast-2.compute.amazonaws.com", "https://simple-sign-frontend-orpin.vercel.app")
